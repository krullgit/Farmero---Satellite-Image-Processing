...
public class ImageClassifierAlexNetPlantDiseases extends ImageClassifier {
     ...
     * @param activity
     */
    ImageClassifierAlexNetPlantDiseases(Activity activity) throws IOException {
        super(activity);
    ...
    protected String getModelPath() {
        ...
        return "alexnetmodel.tflite";
    }

    @Override
    protected String getLabelPath() {
        return "labels_plant_diseases.txt";
    }
